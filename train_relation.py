...
# epochs=1
    ...
    ckpt_path = os.path.join(checkpoint_dir, 'ep{epoch:03d}_loss{val_loss:.4f}_hor-iou{val_horizontal_relation_mask_IoU_score:.4f}_ver-iou{val_vertical_relation_mask_IoU_score:.4f}.h5')
    callbacks = [
